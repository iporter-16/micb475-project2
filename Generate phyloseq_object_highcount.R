...
colombia_filt_samps_highcount <- prune_samples(sample_sums(colombia_filt)>100, colombia_filt)
...
### Rarefy ###
phyloseq_object_final_highcount <- rarefy_even_depth(colombia_filt_samps, rngseed = 1, sample.size = 22700)

### Save ###
save(colombia_filt_samps_highcount, file="colombia_filt_samps_highscount.RData")
save(phyloseq_object_final_highcount, file="phyloseq_object_final_highcount.RData")
